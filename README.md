<html lang="en">
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  transition: transform 0.3s ease; /* เผื่ออยากทำเอฟเฟกต์ */
}

.top-image:hover {
  transform: scale(1.1) rotate(5deg); /* ขยาย + เอียงเวลาเอาเมาส์ไปชี้ */
}

    font-family: 'Comic Sans MS', cursive, sans-serif;
    background: url('https://i.postimg.cc/3wjsKkCP/20250920-010358.jpg') no-repeat center center fixed;
...
.popp-imgg {
  position: absolute;   /* ให้อิสระจาก layout ปกติ */
  top: 17px;            /* ขยับลงมาจากด้านบน 30px */
  left: 790px;           /* ขยับมาจากซ้าย 50px */
  width: 100px;          /* ปรับขนาดความกว้าง */
  height: auto;         /* ให้ปรับสัดส่วนอัตโนมัติ */
}
...
button:active {
 ...
 <body id="pageBody">
    <img src="https://i.postimg.cc/5yk6R14j/1758317945441.png"width="10%" height="19%" class="top-image" id="backToLogin">
...
<div class="center-container" id="imageContainer">
  ...
  <div class="login-box" id="imageBox">
    ...
    <img src="https://i.postimg.cc/Dfqhp7zN/1758318217310.png"width="20%" height="20%" class="popp-imgg">
  </div>
</div>

  <!-- กล่องข้อความมุมขวาล่าง -->
  <div id="bottomRightBox">ดีฮ่ะ สำหรับคนที่เข้ามาลองดูก็นี่ฮับ<br> Username **korawit** Password **0301**<br> ถ้าใส่ของตัวเองก็น่าจะไม่ได้น่ะ💖</div>
...
document.getElementById('backToLogin').addEventListener('click', function() {
  ...
  const body = document.getElementById('pageBody');
  body.style.backgroundImage = "url('https://i.postimg.cc/3wjsKkCP/20250920-010358.jpg')";
  body.style.backgroundSize = "cover";
  body.style.backgroundPosition = "center";
